...
**Document:** docs/sprint-artifacts/2-3-implement-narrative-archetypes-for-coherence.context.xml
...
- ✓ Story fields (asA/iWant/soThat) captured
  - **Evidence:** `<asA>game designer</asA>`, `<iWant>to guide the AI with narrative archetypes or story skeletons</iWant>`, `<soThat>the generated stories remain coherent and logical across playthroughs</soThat>`
- ✓ Acceptance criteria list matches story draft exactly (no invention)
  - **Evidence:** The two `<criterion>` elements match the ACs in `2-3-implement-narrative-archetypes-for-coherence.md`.
